...
class Helper
{
    ...
    function display_text(array $array)
    {
        ...
        <div"; if($variables['bootstrap'] && $variables['width']) echo" class='col-lg-".$variables['width']." col-md-".$variables['width']." col-sm-".$variables['width']."'"; echo">
            <input "; if($variables['bootstrap']) echo" class='form-control'
            type='text' 
    ...
    function display_select($parameters, $array_names, $array_values = null)
    {
        ...
        if($array['default_selected'] && !$array['selected']) echo "<option selected='selected' "; if($array['default_selected']=='Select one') echo "value='-1'"; else echo "value='".$array['default_selected']."'";
        ...
        if($array_values){
            for($i = 0; $i < count($array_names); $i++){
                ...
                if($array_names[$i] == $array['selected']){
                    echo "<option value='" . $key . "' selected>" . $array_names[$i] . "</option>";
                }else {
